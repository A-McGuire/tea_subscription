...
customer_subscription4 = FactoryBot.create(:customer_subscription, active: :true, customer_id: customer2.id, subscription_id: subscription4.id)
customer_subscription5 = FactoryBot.create(:customer_subscription, active: :true, customer_id: customer2.id, subscription_id: subscription5.id)
customer_subscription6 = FactoryBot.create(:customer_subscription, active: :true, customer_id: customer3.id, subscription_id: subscription1.id)
customer_subscription7 = FactoryBot.create(:customer_subscription, active: :false, customer_id: customer4.id, subscription_id: subscription2.id)
customer_subscription8 = FactoryBot.create(:customer_subscription, active: :false, customer_id: customer4.id, subscription_id: subscription3.id)
customer_subscription9 = FactoryBot.create(:customer_subscription, active: :false, customer_id: customer5.id, subscription_id: subscription4.id)
customer_subscription10 = FactoryBot.create(:customer_subscription, active: :false, customer_id: customer1.id, subscription_id: subscription5.id)